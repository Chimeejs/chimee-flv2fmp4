...
var _spsParser = __webpack_require__(2);
...
var tagDemux = function () {
    ...
    _createClass(tagDemux, [{
        ...
        value: function _parseVideoData(arrayBuffer, dataOffset, dataSize, tagTimestamp, tagPosition) {
            ...
            if (codecId !== 7) {
                throw new _error2.default('Flv: Unsupported codec in video frame: ' + codecId);
                // return;
            }
        ...
        value: function _parseAVCVideoPacket(arrayBuffer, dataOffset, dataSize, tagTimestamp, tagPosition, frameType) {
            ...
            if (packetType === 0) {
                ...
                throw new _error2.default('Flv: Invalid video packet type ' + packetType);
            }
        }
...
var _expGolomb = __webpack_require__(9);
...
var _mp4remux = __webpack_require__(3);

var _mp4remux2 = _interopRequireDefault(_mp4remux);

var _mp4moof = __webpack_require__(11);

var _mp4moof2 = _interopRequireDefault(_mp4moof);

var _chimeeHelper = __webpack_require__(15);
...
var flv2fmp4 = function () {
    ...
    function flv2fmp4(config) {
        ...
        _tagdemux2.default._onError = this.error.bind(this);
    ...
    _createClass(flv2fmp4, [{
        ...
        value: function setflvBasefrist(arraybuff, baseTime) {
            var offset = 0;
            try {
                offset = _flvParse2.default.setFlv(new Uint8Array(arraybuff));
            } catch (error) {
                this.error(error);
            }
...
var CPU = function (_CustEvent) {
    _inherits(CPU, _CustEvent);
...
var _decodeUTF = __webpack_require__(8);
...
var _mediaSegmentInfo = __webpack_require__(14);
        ...
        */
        ...
        value: function remux(audioTrack, videoTrack) {
            if (!this._onMediaSegment) {
                throw new _error2.default('MP4Remuxer: onMediaSegment callback must be specificed!');
            }
        ...
        value: function _onTrackMetadataReceived(type, metadata) {
            ...
            if (!this._onInitSegment) {
                throw new _error2.default('MP4Remuxer: onInitSegment callback must be specified!');
            }
