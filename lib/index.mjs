...
var MP4Remuxer$1 = function () {
    function MP4Remuxer(config) {
        ...
        this._forceFirstIDR = Browser$1.chrome && (Browser$1.version.major < 50 || Browser$1.version.major === 50 && Browser$1.version.build < 2661) ? true : false;

        // Workaround for IE11/Edge: Fill silent aac frame after keyframe-seeking
        // Make audio beginDts equals with video beginDts, in order to fix seek freeze
        this._fillSilentAfterSeek = Browser$1.msedge || Browser$1.msie;

        // While only FireFox supports 'audio/mp4, codecs="mp3"', use 'audio/mpeg' for chrome, safari, ...
        this._mp3UseMpegAudio = !Browser$1.firefox;
    }
...
var flv2fmp4 = function () {
    ...
    function flv2fmp4(config) {
        ...
        _Object$assign(this._config, config);
